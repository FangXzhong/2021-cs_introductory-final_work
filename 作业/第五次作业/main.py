...
class Calculator:
    def __init__(self):
        self.window = tk.Tk()
        self.window.title('小小计算器')
        # 指定窗口大小和默认所处位置
        self.window.geometry("295x280+150+150")
